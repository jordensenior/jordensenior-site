---
title: "001 · A Brief History of Mordançage"
...
Enter Jean-Pierre Sudre, a French photographer who in the 1960s saw artistic potential where others saw only chemistry. Working from his research centre in Lacoste, Sudre made a crucial modification: replacing citric acid with glacial acetic acid. This single change transformed a technical curiosity into a controllable artistic medium. By 1967, his mordançage works were hanging in MoMA's "A European Experiment" exhibition, introducing American audiences to this alchemical process.
...
## The Chemistry: What Is Actually Happening in That Tray
...
This temperature is important. Too cool, and the gelatin stays rigid. Too hot, and your entire emulsion might dissolve into soup. You're looking for that Goldilocks zone where the emulsion becomes like wet fabric – moveable but intact.
...
**Ilford Multigrade** papers remain the gold standard. Both fibre-based and resin-coated versions work, though fibre-based papers allow more dramatic effects due to how the emulsion integrates with the paper fibres. Sometimes, you may need to do a second pass with RC paper - i.e., first weaken the gelatin with the Mordançage solution and hot water processes, then do it again. 
...
Here's something interesting: despite decades of experimentation, there's no documented successful mordançage on C41 colour films or RA4 colour papers. The chemistry tells us why.

Colour materials create images through dyes, not silver particles. During C41 processing, colour couplers react with oxidised developers to form cyan, magenta, and yellow dyes. The silver that was there gets bleached away entirely during normal processing. No silver, no mordançage – the copper ions have nothing to oxidise.

That being said, if one performs a bleach bypass during C41 development (i.e., skips the bleach to leave the silver), mordançage effects can occur, with artists such as [Ella Morton](https://www.ellamorton.com/photo-based-work#/the-residue-of-starlight/) active on using this technique, in combination with film soup, to make stunning alien-landscapes forged in extreme conditions and locations. 
...
Mordançage sits at an intersection we keep losing: you have to understand the chemistry to control it, and feel the exact moment the gelatin releases under your fingers in the hot-water bath. Neither half works without the other. A hundred and twenty-five years after Liesegang's notebooks, that's still what pulls me back to the tray — not nostalgia, but a process that turns a fixed photograph into something you can lift, drape, and remake by hand.
