...
Your fixer contains **3,000–8,000 mg/L dissolved silver**.
Aquatic life dies at **0.6 μg/L**.
...
- Mordançage bleach (when exhausted)
- Chromo solutions
...
This darkroom uses two-bath fixing to extend fixer life 4–10×.
...
| 🔴 | Full/offline | DO NOT add fixer—notify staff |
...
☐ Check fixer test log—is fixer still good?
☐ Check silver recovery status
☐ Know where waste containers are
☐ Have appropriate PPE for your process

### During Processing

☐ Use chemistry efficiently (don't overfill trays)
☐ Return reusable chemistry to storage containers
☐ Wipe up spills immediately
☐ Keep work area clean

### When You Finish

☐ Fixer → silver-bearing waste container
☐ Developer → drain (if oxidised) or storage (if reusable)
☐ Stop bath → neutralise and drain, or storage
☐ Rinse trays (first rinse to appropriate container)
☐ Log your session
☐ Leave space clean for next user
...
- Temperature control—don't waste chemistry on failed batches

### Lith Printing
- Standard B&W waste profile
- Developer is very dilute—drain-safe when exhausted
...
- Gum bichromate: **DICHROMATE IS CARCINOGENIC**—special handling required
